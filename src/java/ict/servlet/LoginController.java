...
public class LoginController extends HttpServlet {
    ...
    private void doAuthenticate(HttpServletRequest request, HttpServletResponse response)
        ...
        if (isValid) {
            ...
            UserInfo ui = db.queryAccountInfo(email);
            // store the userInfo to the session
            session.setAttribute("userInfo", ui);
            if ("C".equals(ui.getType())) {
                targetURL = "custMain.jsp";
            } else if ("S".equals(ui.getType()) || "P".equals(ui.getType())) {
                targetURL = "staffMain.jsp";
            } else if ("M".equals(ui.getType())) {
                targetURL = "smMain.jsp";
            } else {
